...
class CommentWidgetFront extends WP_Widget {
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <p><a href="<?php echo $post->guid;?>"
                      class="btn btn-danger btn-md font-roboto mt-lg mb-lg"><strong>Participe do debate!</strong></a></p>
            </div>
        </div>
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <select class="widefat" id="<?php echo $this->get_field_id( 'textID' ); ?>" name="<?php echo $this->get_field_name( 'textID' ); ?>">
                <?php foreach($select as $id => $textTitle):?>
                <option value="<?php echo $id;?>"<?php if($selectId == $id):?> selected<?php endif;?>><?php echo $textTitle;?></option>
                <?php endforeach;?>
            </select>
        </p>
        <p>
